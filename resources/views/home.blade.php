        ...
        <h4 class="fw-bold py-3 mb-4" style="margin-left:56%; ">
            ...
            <div style="">
                <form action="{{ route('search') }}" method="GET" style="">
                    ...
                    <input type="search" style="width: 150px; ; display: inline-block !important" id="search" name="search" class="form-control" placeholder="Search Documents...">
